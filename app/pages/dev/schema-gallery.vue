...
const sections: Section[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { label: 'mixed object + primitive (Foo | string)', schema: { anyOf: [{ id: 'Foo', type: 'object', properties: { x: { type: 'string' } }, required: ['x'] } as any, { type: 'string' }] }, needsInvestigation: true },
