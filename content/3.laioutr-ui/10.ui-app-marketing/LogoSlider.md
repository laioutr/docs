...
- One section for logos in grid or slider so partners and certifications are easy to add.
- Per-logo link and background support flexible branding.
- Grid and slider modes fit different space and emphasis.
- Navigation and alignment options keep the section flexible.

:::tip
Pro-Tip from Larry: Use Logo Slider for partners and certifications so trust signals are visible without clutter.
:::
...
::component-meta{:name="SectionLogoSlider"}
::

### BlockLogoSliderSlide

::component-meta{:name="BlockLogoSliderSlide"}
::
