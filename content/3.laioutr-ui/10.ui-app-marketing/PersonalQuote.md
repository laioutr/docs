...
- Testimonials with profile image and quote build trust on landing and product pages.
- Multiple profile styles and themes fit different brands.
- Slider or single quote supports one or many testimonials.
- Optional company logo and job title add credibility.

:::tip
Pro-Tip from Larry: Use Personal Quote for testimonials so social proof is visible without a separate page.
:::
...
::component-code
---
:name: LuiPersonaQuote
story-id: molecules-personaquote--default
---
::
