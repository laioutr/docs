...
For longer logo lists that benefit from rotation, switch to [`LogoSlider`](/laioutr-ui/cms/slider/logo-slider). The two components share the same `slides` shape, so you can swap layouts without restructuring data.
