...
`QuoteCardSlider` wraps multiple [`QuoteCard`](/laioutr-ui/cms/quotes/quote-card) items in a slider. Use it for review and testimonial rotations on PDP and homepage.

For testimonials that lead with a profile picture, reach for [`PersonaQuoteSlider`](/laioutr-ui/cms/quotes/persona-quote-slider) instead.
...
::component-meta{:name="QuoteCardSlider"}
::
