...
All data your storefront application needs, lives in this file. All other data comes from external systems which are connected through apps via the [Orchestr API](/frontend/orchestr).
...
::card{title="Create your own app" to="/getting-started/next-steps/local-setup"}
