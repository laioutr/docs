...
This works for both extending existing entities and creating entirely new entity types. See [Component Resolvers](/frontend/orchestr/component-resolvers) for a full walkthrough with code examples.
