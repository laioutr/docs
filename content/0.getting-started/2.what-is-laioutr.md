...
seo:
  title: What is Laioutr?
sitemap:
  loc: /getting-started/what-is-laioutr
  lastmod: 2026-07-28
  changefreq: monthly
  priority: 1.0
...
You create the project itself in [the Cockpit](https://cockpit.laioutr.cloud), which generates and hosts the Nuxt app. Locally you build **apps** for it — Nuxt modules that add sections, blocks, and integrations:

```bash
# Scaffold a Laioutr app: a Nuxt module under the hood
npx giget@latest gh:laioutr/app-starter
```

See [Setup Local Development Environment](/getting-started/next-steps/local-setup) for the full walkthrough, including registry access, fetching your project configuration, and running the playground.
...
::card-group
  ...
  :::card{title="Cloud" to="/offering/products/cloud"}
