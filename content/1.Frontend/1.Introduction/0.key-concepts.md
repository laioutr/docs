...
Together, these concepts let you build a storefront that is **configurable in Studio**, **powered by any backend** via Orchestr and apps, and **extensible** with new features and adapters. For more, see [Features](/frontend/features) and [Orchestr](/frontend/3-orchestr).
