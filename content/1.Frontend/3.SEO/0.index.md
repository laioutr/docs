...
::card-group
  :::card{target="_self" title="Robots.txt" to="/frontend/3-seo/robots-txt"}
  ...
  :::card{target="_self" title="Sitemap" to="/frontend/3-seo/sitemap"}
  ...
  :::card{target="_self" title="OG Image" to="/frontend/3-seo/og-image"}
  ...
  :::card{target="_self" title="Schema.org" to="/frontend/3-seo/schema-org"}
  ...
  :::card{target="_self" title="Link Checker" to="/frontend/3-seo/link-checker"}
