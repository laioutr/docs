...
- **[Link Handlers](/frontend/orchestr/queries)**: Define relationships between entities
- **[Component Resolvers](/frontend/orchestr/queries)**: Resolve specific data components for entities
...
::card-group
  ...
  :::card{title="Link Token" to="/frontend/orchestr/queries"}
  ...
  :::card{title="Component Token" to="/frontend/orchestr/queries"}
