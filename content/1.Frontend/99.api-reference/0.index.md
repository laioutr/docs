...
Some shapes recur across many entities, queries, and actions (e.g. the `Link` discriminated union returned by breadcrumb items, menu items, and CTA fields, or the `Media` union returned wherever an entity exposes images or videos). Browse these in the [Common Types](/frontend/api-reference/common-types) section.
