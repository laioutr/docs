...
Some shapes recur across many entities, queries, and actions (e.g. the `Link` discriminated union returned by breadcrumb items, menu items, and CTA fields). Browse these in the [Common Types](/frontend/api-reference/common-types) section.
