...
> **new CustomerDisabledError**(): `CustomerDisabledError`
...
| [](){#code-1} `code`                     | `"AUTH_CUSTOMER_DISABLED"`     | `'AUTH_CUSTOMER_DISABLED'` | ‐                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
`ForbiddenError.captureStackTrace`
...
`ForbiddenError.prepareStackTrace`
