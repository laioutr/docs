---
title: ProductSoldOutError
description: declaration
---

Thrown when a product that should be added to the cart is already sold out.
...
> **new ProductSoldOutError**(`variantId`: `string`): `ProductSoldOutError`
...
| [](){#data} `data`                       | { `variantId`: `string`; }     | `undefined`               | Additional data associated with the error. This property can hold&#xA;unstructured information or supplementary details that provide context&#xA;to the error.                                                                                                                                                                                                                                                                                                  |
...
| [](){#code-1} `code`                     | `"CART_PRODUCT_SOLD_OUT"`      | `'CART_PRODUCT_SOLD_OUT'` | ‐                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
