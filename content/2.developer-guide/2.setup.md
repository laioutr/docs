...
You do not _have_ to use the template, but it will give you a good starting point.
...
<img src="/assets/img/chrome-local-network-access.png" alt="Chrome Permission Dialog" width="500" />
